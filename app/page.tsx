      ...
      <section className="mx-auto max-w-5xl px-6 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">
            Paste a lead. Know if it’s worth your time.
          </h1>

          <p className="mt-6 text-lg leading-8 text-slate-600">
            Drop in any enquiry, email, or DM and instantly see if it’s
            qualified, what’s missing, and what to say next.
          </p>
        </div>
              ...
              <div className="flex h-full min-h-[320px] flex-col justify-between">
                ...
                <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    “Hi, we’re looking for someone to help us generate more
                    inbound enquiries for our firm. We’d like to get started
                    this quarter.”
                  </p>
                </div>
              </div>
